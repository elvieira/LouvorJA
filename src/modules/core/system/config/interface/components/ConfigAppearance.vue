        ...
        >
          <v-item v-slot="{ isSelected, toggle }" value="light">
            <v-card
              ...
              :style="isSelected ? 'background: rgba(0,151,215,0.08); border: 2px solid var(--accent-blue) !important; border-radius: 20px !important;' : 'background: var(--main-bg); border: 2px solid transparent !important; border-radius: 20px !important; box-shadow: inset 0 0 0 1px var(--border-color);'"
              @click="toggle"
            >
