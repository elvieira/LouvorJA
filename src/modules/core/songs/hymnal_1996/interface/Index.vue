          ...
          >
            ...
            <v-card class="modern-glass-menu elevation-4 mt-2" rounded="lg">
              <v-list class="py-1" bg-color="transparent" density="compact">
                <v-list-item class="mx-1 rounded" style="min-height: 32px;" @click.stop="$media.playAll(data.unformatted_data, 'audio', module_id, hymnal1996Img)">
                ...
                <v-list-item class="mx-1 rounded" style="min-height: 32px;" @click.stop="$media.playAll(data.unformatted_data, 'instrumental', module_id, hymnal1996Img)">
                  <div class="d-flex align-center">
                    <v-icon size="small" class="mr-2">
